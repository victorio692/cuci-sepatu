    ...
    <div class="px-4 md:px-6 py-4 border-b border-gray-200 flex flex-col gap-3 md:flex-row md:items-center md:justify-between bg-gray-50">
        ...
        <div class="relative w-full md:w-64">
            <input 
                ...
                onkeyup="searchTable()"
                class="w-full pl-4 md:pl-12 pr-10 md:pr-4 py-2 text-xs md:text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
            >
            <i class="fas fa-search absolute right-3 md:right-auto md:left-4 top-1/2 transform -translate-y-1/2 text-gray-400 pointer-events-none"></i>
        </div>
    </div>
