            ...
            <div class="lg:col-span-3">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    <div class="px-6 py-5 border-b border-gray-200">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Ubah nomor telepon Anda untuk keperluan kontak</p>
                    </div>
                    
                    <div class="p-6">
                        <form action="/change-phone" method="POST" class="max-w-2xl">
                            <?= csrf_field() ?>
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="flex gap-3 pt-4">
                                    <button type="submit" class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition">
                                        <i class="fas fa-check"></i> Ubah Nomor
                                    </button>
